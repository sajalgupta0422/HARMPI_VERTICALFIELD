	       ...
	       FTYPE gdet, FTYPE prim[NPR])
{
  ...
  for(i = BCON1; i <= BCON3; i++) prim[i] = U[i] / gdet ; //// This shows magnetic fields are treated specially during primitive recovery, but still stored in the same cell-centered array
