...
// Main driver function that translates between conserved (U) and primitive (P) variables
******************************************************************/
...
#if( eHEAT || eCOND)
  //compute evolved entropy
  prim[KELDIS] = U[KELDIS]/U[RHO];
  prim[KEL4] = U[KEL4]/U[RHO];
  prim[KEL4A] = U[KEL4A]/U[RHO];
  prim[KEL4B] = U[KEL4B]/U[RHO];
  prim[KEL4C] = U[KEL4C]/U[RHO];
  prim[KEL4D] = U[KEL4D]/U[RHO];
  prim[KEL4E] = U[KEL4E]/U[RHO];
  prim[KEL5] = U[KEL5]/U[RHO];
    prim[PHI] = U[PHI]/U[RHO];
#if(DOFLR)
...
// Core inversion routine that attempts conversion from U to prim
**********************************************************************************/
...
// Functions for calculating residuals and Jacobians in the NR method
 *********************************************************************************/
