...
ifeq ($(USEICC),1)
CC       = mpicc
CCFLAGS2  = -cc=icc -O2 -xhost -restrict -no-prec-div -axCORE-AVX2 -xSSE4.2 #-O2 -xAVX 
#CCFLAGS  = -O2
ifeq ($(USEOMP),1)
...
ifeq ($(USEICC),0)
CC       = gcc
CCFLAGS1  = -g -O3 #-ggdb -Wall -Wextra -Wno-unused-variable -Wno-unused-parameter -Wno-unused-but-set-variable -Wno-unknown-pragmas  #-fsanitize=address -fno-omit-frame-pointer
ifeq ($(USEOMP),1)
...
SRCS = \
bounds.c coord.c diag.c dump.c electron.c fft.c fixup.c \
...
madfield.c particles.c

OBJS = \
bounds.o coord.o diag.o dump.o electron.o fft.o fixup.o \
...
madfield.o particles.o

INCS = decs.h  defs.h  u2p_defs.h  u2p_util.h  mpi.h electron.h
